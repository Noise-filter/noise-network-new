function(set_compiler_warnings target_name)
  if(CMAKE_SYSTEM_NAME STREQUAL "Windows")
    target_compile_options(
      ${target_name}
      PRIVATE /W4 # Baseline reasonable warnings
              ...
              # is not virtual instances of this class may not be destructed
              # correctly
              /w14287 # 'operator': unsigned/negative constant mismatch
              /we4289 # nonstandard extension used: 'variable': loop control
              # variable declared in the for-loop is used outside the for-loop
              # scope
  ...
  elseif(CMAKE_SYSTEM_NAME STREQUAL "Linux")
    target_compile_options(
      ...
      PRIVATE -Wall
              ...
              # functions has a non-virtual destructor. This helps catch hard to
